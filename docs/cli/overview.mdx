...
<CardGroup cols={2}>
  <Card title="Multiple AI Agents" icon="robot">
    Choose from Claude, GPT-4, Gemini, or open-source models for code generation
  </Card>
  <Card title="Sandboxed Environments" icon="box">
    Isolated, reproducible development environments with full control
  </Card>
  <Card title="Git Integration" icon="code-branch">
    Create pull requests and manage branches directly from the CLI
  </Card>
  <Card title="Provider Flexibility" icon="plug">
    Support for multiple sandbox providers to suit your infrastructure
  </Card>
</CardGroup>
