---
title: VibeKit Proxy
description: "A zero-latency safety and security proxy for AI that redacts sensitive data on both input and output, blocks prompt injection, and shields your models from malicious inputs — without slowing you down."
---

## Features

<CardGroup cols={2}>
  <Card title="Real-Time Data Redaction" icon="shield-check">
  ...
  <Card title="AI Threat Intelligence" icon="brain">
