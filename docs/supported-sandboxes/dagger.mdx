...
Dagger now supports multiple container registries for storing and sharing pre-built agent images. Choose the registry that best fits your infrastructure and security requirements.
...
const config: VibeConfig = {
  ...
  environment: {
    ...
    config: {
      ...
      registryUser: "your-username", // Universal registry username
      registryName: "dockerhub",     // Optional: specify registry (dockerhub, ghcr, ecr)
    },
  },
};
